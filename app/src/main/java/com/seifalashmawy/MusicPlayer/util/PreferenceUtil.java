...
import com.seifalashmawy.MusicPlayer.model.CategoryInfo;
...
public final class PreferenceUtil {
    ...
    public static int getThemeResFromPrefValue(String themePrefValue) {
        switch (themePrefValue) {
            ...
            case "dark":
            default:
                return R.style.Theme_Phonograph_Black; // Theme_Phonograph_Light WAS THE MAIN HERE changed to  Theme_Phonograph
        }
    }
