package com.seifalashmawy.MusicPlayer.ui.fragments.mainactivity.folders;
...
import com.seifalashmawy.MusicPlayer.adapter.SongFileAdapter;
import com.seifalashmawy.MusicPlayer.helper.MusicPlayerRemote;
import com.seifalashmawy.MusicPlayer.helper.menu.SongMenuHelper;
import com.seifalashmawy.MusicPlayer.helper.menu.SongsMenuHelper;
import com.seifalashmawy.MusicPlayer.interfaces.CabHolder;
import com.seifalashmawy.MusicPlayer.interfaces.LoaderIds;
import com.seifalashmawy.MusicPlayer.misc.DialogAsyncTask;
import com.seifalashmawy.MusicPlayer.misc.UpdateToastMediaScannerCompletionListener;
import com.seifalashmawy.MusicPlayer.misc.WrappedAsyncTaskLoader;
...
import com.seifalashmawy.MusicPlayer.util.FileUtil;
import com.seifalashmawy.MusicPlayer.util.PhonographColorUtil;
import com.seifalashmawy.MusicPlayer.util.PreferenceUtil;
import com.seifalashmawy.MusicPlayer.util.ViewUtil;
import com.seifalashmawy.MusicPlayer.views.BreadCrumbLayout;
...
public class FoldersFragment extends AbsMainActivityFragment implements MainActivity.MainActivityFragmentCallbacks, CabHolder, BreadCrumbLayout.SelectionCallback, SongFileAdapter.Callbacks, AppBarLayout.OnOffsetChangedListener, LoaderManager.LoaderCallbacks<List<File>> {
    ...
    private void setUpAppbarColor() {
        ...
        breadCrumbs.setBackgroundColor(getResources().getColor(R.color.black));
        breadCrumbs.setActivatedContentColor(ToolbarContentTintHelper.toolbarTitleColor(getActivity(), getResources().getColor(R.color.black)));
        breadCrumbs.setDeactivatedContentColor(ToolbarContentTintHelper.toolbarSubtitleColor(getActivity(), getResources().getColor(R.color.black)));
    }
