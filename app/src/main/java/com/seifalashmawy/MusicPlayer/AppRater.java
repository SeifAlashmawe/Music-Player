package com.seifalashmawy.MusicPlayer;
...
public class AppRater {
    ...
    private final static String APP_TITLE = "Ashe";
    private final static String APP_PACKAGE_NAME = "com.seifalashmawy.MusicPlayer";
    ...
    public static void showRateDialog(final Context context, final SharedPreferences.Editor editor) {
        ...
        String message =  "please take a moment to rate our app";
...
//					For test purposes we catch it here and show some text.
                ...
                .setNegativeButton("No Thanksً", new DialogInterface.OnClickListener() {
